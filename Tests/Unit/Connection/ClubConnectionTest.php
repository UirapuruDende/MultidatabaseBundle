<?php
namespace Dende\MultidatabaseBundle\Tests\Unit\Connection;

use Dende\MultidatabaseBundle\Connection\ClubConnection;
use Dende\MultidatabaseBundle\Exception\UserHasNoClubsException;
use Mockery as m;
...
class ClubConnectionTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @expectedException Dende\MultidatabaseBundle\Exception\UserHasNoClubsException
